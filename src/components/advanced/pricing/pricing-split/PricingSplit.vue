      ...
      <div class="split-card-left">
        <div class="split-card-head">
          <Title
            ...
            leading
          >
            <span>طرح‌های سطح پایه</span>
          </Title>
          <p class="paragraph">
            پرداخت به صورت مصرفی
          </p>
        </div>
      ...
      >
        <div class="split-card-head">
          ...
          <p class="paragraph is-inverted-light">
            گزینه‌های غنی از ویژگی با مقیاس تجاری
          </p>
        </div>
        <div class="split-card-body">
    ...
    .right-plan {
      ...
      .plan-features {
        ...
        .plan-feature {
          ...
          &:nth-child(odd) {
            border-inline-end: 1px solid var(--dark-bg-light-10);
          }
        }
      }
    }
