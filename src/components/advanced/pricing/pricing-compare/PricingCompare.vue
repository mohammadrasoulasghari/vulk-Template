  ...
  <div class="py-6">
    ...
    >
      ...
      <p class="paragraph max-w-6">
        قیمت‌ها و/یا مشخصات محصولات طبق اطلاعات منتشرشده توسط تأمین‌کنندگان
        نام‌برده در وب‌سایت‌های خود در تاریخ‌های ذکرشده است و ممکن است در هر
        زمانی بدون اطلاع قبلی تغییر کنند.
      </p>
      <div
        v-if="props.polkaDots"
...
.is-dark {
  .compare-cards {
    .compare-card:not(.is-featured, .is-popular) {
      .plan-logo {
        img {
          filter: invert(1);
        }
