        ...
        >
          ...
          >
            ...
            <Subtitle
              ...
              class="pt-2"
            >
              {{ props.content.date }} — {{ props.content.duration }} دقیقه
              مطالعه
            </Subtitle>
          </div>
          <div class="metadata">
    ...
    <div class="post-body">
      ...
      <div class="sharing-options">
        <a>
          ...
          />
          <span class="is-sr-only">فیسبوک</span>
        </a>
        <a>
          <i
            class="iconify"
          ...
          />
          <span class="is-sr-only">ایکس</span>
        </a>
        <a>
          <i
            class="iconify"
          ...
          />
          <span class="is-sr-only">لینکدین</span>
        </a>
        <a>
          <i
            class="iconify"
          ...
          />
          <span class="is-sr-only">ایمیل</span>
        </a>
      </div>
    </div>
    <Title
