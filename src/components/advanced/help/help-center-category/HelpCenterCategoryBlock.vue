...
<template>
  <div class="help-container">
    <div class="help-toolbar">
      ...
      >
        <i-ph-arrow-left-bold v-if="!rtl" />
        <i-ph-arrow-right-bold v-else />
        <span>بازگشت</span>
      </a>
    </div>
          ...
          <div class="card-meta">
            ...
            <div class="meta-info">
              <div class="articles-number">
                {{ props.category.articles.length }} مقالات در این بخش
              </div>
              <div class="authors">
                نوشته شده توسط
                ...
                <span v-if="props.category.contributors.length > 1">
                  و {{ props.category.contributors.length - 1 }}
                  <span v-if="props.category.contributors.length - 2 < 1">
                    دیگری
                  </span>
                  <span v-else>نفر دیگر</span>
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="inner-content">
              ...
              <div class="card-meta">
                ...
                <div class="meta-info">
                  ...
                  <div class="status">
                    بروز شده در حدود {{ article.updated }}
                  </div>
                </div>
              </div>
            </div>
