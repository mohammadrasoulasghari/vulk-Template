        ...
        <div class="column is-6">
          <div class="nft-info">
            <div class="nft-info-head">
              ...
              <div class="actions">
                <RouterLink
                  to="/subpages/nfts/nft-list/"
                  class="action"
                >
                  <i-ic-baseline-arrow-back v-if="!rtl" />
                  <i-ic-baseline-arrow-forward v-else />
                </RouterLink>
                <button class="action">
                  <i-ph-heart-duotone />
                </button>
            ...
            <div class="nft-info-price">
              ...
              <span class="dollar-price">
                ({{ props.nft.initialBid.dollar }} تومان)
              </span>
              <span class="paragraph px-1">·</span>
              <span class="collection-rank">
                1 از {{ props.nft.collection.items }}
              </span>
            </div>
            ...
            <div class="nft-info-tabs">
              <div class="nft-info-tabs-inner">
                <Tabs
                  selected="bids"
                  :tabs="[
                    { label: 'پیشنهادات', value: 'bids' },
                    { label: 'دیدگاه‌ها', value: 'comments' },
                  ]"
                >
                  <template #tab="{ activeValue }">
                    <div v-if="activeValue === 'bids'">
                      <div class="active-bids">
                        ...
                        >
                          ...
                          <div class="meta">
                            <span>پیشنهاد {{ bider.bid }} ETH</span>
                            <span>
                              توسط {{ bider.name }} · {{ bider.time }}
                            </span>
                          </div>
                        </div>
                      </div>
                      <div class="current-bid">
                        <div class="highest-bid">
                          <span class="small-label">بالاترین پیشنهاد</span>
                          <span class="highest-bid-value">
                            ...
                            <span class="highest-bid-dollar">
                              ({{ props.nft.currentBid.dollar }} تومان)
                            </span>
                          </span>
                        </div>
                        <div class="bid-countdown">
                          <span class="small-label">پایان حراج در:</span>
                          <div
                            class="auction-timer"
                            dir="ltr"
                          >
                            ...
                            <div class="timer-block is-separator">
                              :
                            </div>
                            <div class="timer-block">
                    ...
                    <div v-else-if="activeValue === 'comments'">
                      <div v-if="props.nft.comments">
                        <div v-if="props.nft.comments.length > 0" />
                        <div v-else>
                          <div class="py-4">
                            <PlaceholderSection
                              title="بدون دیدگاه"
                              subtitle="به نظر می رسد در حال حاضر نظری در مورد این مورد وجود ندارد."
                            >
                              <template #image>
