...
import { heroMentors } from '/@src/data/pages/mentors'
</script>
          ...
          <div class="column is-relative">
            <div class="hero-caption mx-auto max-w-6 mb-4">
              <Title
                ...
                inverted
              >
                <span>یک مربی برای افزایش رشد کسب و کار خود پیدا کنید</span>
              </Title>
              <Subtitle
                tag="p"
                :size="5"
              ...
              >
                گفتگوهای ۱ به ۱ در مورد رشد، بازاریابی و هر آنچه در این بین وجود
                دارد با ۳ درصد از مربیان راه اندازی و بازاریابی برتر جهان داشته
                باشید.
              </Subtitle>
            </div>
...
.hero-grid {
  ...
  @include gradientAngle(
    var(--hero-nuance-main),
    var(--hero-nuance-sub),
    90deg
  );
  ...
  .strip {
    ...
    &:nth-of-type(1) {
      background: var(--hero-nuance-main);
    }

    &:nth-of-type(2) {
      @include gradientAngle(transparent, var(--hero-nuance-12), 90deg);
    ...
    &:nth-of-type(3) {
      background: var(--hero-nuance-20);
    }

    &:nth-of-type(4) {
      align-self: flex-end;
      background: var(--hero-nuance-12);
    }

    &:nth-of-type(6) {
      align-self: flex-end;
      background: var(--hero-nuance-6);
    }
  }
}
